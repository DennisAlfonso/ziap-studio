...
public static class WeaponPreflightProfile
{
    ...
    [
        ...
        new WeaponDiagnosticRule("weapon.family.unknown", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.subtype.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.handedness.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.handedness.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.combat-profile.missing", PreflightSeverity.Warning),
        new WeaponDiagnosticRule("weapon.combat-profile.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.damage-rate.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.damage-rate.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.flat-damage.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.flat-damage.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.defense-rate.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.defense-rate.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.attack-interval.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.attack-interval.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.attack-range.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.attack-range.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.attack-radius.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.attack-radius.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.projectile-speed.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.projectile-speed.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.projectile-collider.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.projectile-collider.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.subtype.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.magazine.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.magazine.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.reload.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.reload.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.accuracy.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.accuracy.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.stability.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.stability.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.handling.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.handling.missing", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.aim-min.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.aim-max.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.aim-movement.invalid", PreflightSeverity.Error),
        new WeaponDiagnosticRule("weapon.firearm.aim-range.invalid", PreflightSeverity.Error),
